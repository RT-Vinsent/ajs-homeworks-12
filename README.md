...
## Квота на AppVeyor превышена. Написал в поддержку, если добавят возможность пользоваться, то позже добавлю.
...
**Важно**: вы можете использовать преднастроенный [шаблон](https://github.com/RT-Vinsent/ajs-homeworks/tree/ajs8/ts-template).
...
![](https://github.com/RT-Vinsent/ajs-homeworks/raw/ajs8/typescript/pic/avengers.png)
